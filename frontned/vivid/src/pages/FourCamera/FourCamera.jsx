  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.streamgrid}>
        ...
        <StreamViewer monitor="monitor 3" camname={camname3} camport={camport3} x_size={oneVW} y_size={500} />
        <StreamViewer monitor="monitor 4" camname={camname4} camport={camport4} x_size={oneVW} y_size={500} />
      </div>
    </div>
  );
};
